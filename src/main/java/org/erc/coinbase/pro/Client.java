...
public interface Client {
	 ...
	 */
	List<Account> getAccounts(AccountFilter filter) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Account getAccount(String id) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	List<AccountHistory> getAccountHistory(AccountHistoryFilter filter) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	List<Hold> getAccountHolds(AccountHoldFilter filter) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Order placeOrder(OrderRequest request) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	void cancelOrder(String id) throws CoinbaseException;
	 ...
	 */
	List<String> cancelAllOrders(String productId) throws CoinbaseException;
	 ...
	 *             the coinbase exception
	 */
	List<Order> getOrders(OrderFilter orderFilter) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Order getOrder(String id) throws CoinbaseException;
	 ...
	 *             the coinbase exception
	 */
	List<Fill> getFills(FillFilter fillFilter) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Deposit deposit(DepositRequest deposit) throws CoinbaseException;
	 ...
	 *             the coinbase exception
	 */
	Withdrawal withdrawal(WithdrawalRequest withdrawal) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	List<Payment> getPaymentMethods() throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	List<CoinbaseAccount> getCoinbaseAccounts() throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Report createReport(ReportRequest request) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Report getReportStatus(String id) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	List<TrailingVolume> getTrailingVolume() throws CoinbaseException;
	 ...
	 *             the coinbase exception
	 */
	List<Product> getProducts(ProductsFilter productFilter) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Book getProductOrderBook(String productId, int level) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Ticker getProductTicker(String productId) throws CoinbaseException;
	 ...
	 *             the coinbase exception
	 */
	List<Trade> getProductTrades(ProductTradesFilter productFilter) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	Stats getProductStats(String productId) throws CoinbaseException;
	 ...
	 * @throws CoinbaseException the coinbase exception
	 */
	List<Currency> getCurrencies() throws CoinbaseException;
